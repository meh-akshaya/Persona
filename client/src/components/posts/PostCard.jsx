...
export default function PostCard({ post, onReactionUpdated, isDetail = false }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-3 mb-3">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <span className="text-[10px] font-medium px-1.5 py-0.5 rounded-[4px] bg-[#151518] text-[#9A9A9F] border border-[#25252A]">
        ...
        <span className="text-[11px] text-[#6F7076] shrink-0 ml-auto text-right">
      ...
      <div
        className="mt-3 mb-4 select-none min-h-[24px]"
        onCopy={handleCopyAttempt}
        onCut={handleCopyAttempt}
        onDragStart={(e) => e.preventDefault()}
      >
      ...
      {/* Action Toolbar — Dedicated Action Row */}
      <div className="flex items-center justify-between mt-4 text-xs text-[#9A9A9F]">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button
            ...
            className={`h-8 px-3 rounded-[6px] text-xs font-semibold flex items-center gap-1.5 transition-colors cursor-pointer border ${activeReaction === 'HELPFUL'
          ...
          <button
            ...
            className={`h-8 px-3 rounded-[6px] text-xs font-semibold flex items-center gap-1.5 transition-colors cursor-pointer border ${activeReaction === 'INSIGHTFUL'
                ? 'bg-[#F5B800]/15 text-[#F5B800] border-[#F5B800]/40 font-bold'
                : 'bg-[#151518]/80 text-[#9A9A9F] border-[#25252A] hover:text-[#F2F2F2] hover:bg-[#151518]'
              }`}
          >
          ...
          <button
            ...
            className={`h-8 px-3 rounded-[6px] text-xs font-semibold flex items-center gap-1.5 transition-colors cursor-pointer border ${activeReaction === 'SUPPORTIVE'
                ? 'bg-[#F5B800]/15 text-[#F5B800] border-[#F5B800]/40 font-bold'
                : 'bg-[#151518]/80 text-[#9A9A9F] border-[#25252A] hover:text-[#F2F2F2] hover:bg-[#151518]'
              }`}
          >
          ...
          {reactionsCount > 0 && (
            <span className="text-[11px] font-semibold text-[#6F7076] ml-1">
              {reactionsCount}
            </span>
          )}
        </div>
        ...
        <CleanLink
          to={`/post/${post.id}`}
          className="ml-auto shrink-0 flex items-center h-8 gap-1.5 px-3 rounded-[6px] bg-[#151518]/80 border border-[#25252A] text-xs text-[#9A9A9F] hover:text-[#F2F2F2] hover:bg-[#151518] font-medium transition-colors"
        >
          <svg className="w-3.5 h-3.5 fill-none stroke-current" strokeWidth="1.75" viewBox="0 0 24 24">
